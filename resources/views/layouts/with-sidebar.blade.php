...
<head>
    ...
    <title>Pwani - {{ $title ?? 'Supplier Portal' }}</title>
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="flex-grow-1 ps-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-start">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ route('supplier.logout') }}">Log out</a>
                            </div>
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
                                ...
                                <a class="dropdown-item" href="#">
                                    <img src="{{ asset('img/flags/es.png') }}" alt="Spanish" width="20"
                                        class="align-middle me-1" />
                                    <span class="align-middle">Spanish</span>
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="{{ asset('img/flags/ru.png') }}" alt="Russian" width="20"
                                        class="align-middle me-1" />
                                    <span class="align-middle">Russian</span>
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="{{ asset('img/flags/de.png') }}" alt="German" width="20"
                                        class="align-middle me-1" />
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a href="https://appsbizsol.com" target="_blank" class="text-muted">
                                    <strong>ABSOL</strong></a> &copy; {{ date('Y') }}
                            </p>
                        </div>
                        <div class="col-6 text-end">
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <a class="text-muted" href="{{ route('support') }}">Support</a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="text-muted" href="{{ route('help-center') }}">Help Center</a>
                                </li>
                                <li class="list-inline-item">
